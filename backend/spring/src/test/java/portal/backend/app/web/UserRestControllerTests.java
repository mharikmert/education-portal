// package portal.backend.app.web;
//
...
//
// //test User
// User user = new User(5L,"password", "testFirstName",
...
// Assertions.assertTrue(result.getStatusCodeValue() == 201 ||
// result.getStatusCodeValue() == 409);
//
...
// this.restTemplate.getForEntity(baseUrl, User[].class);
// List<User> userList =
...
//
// final String baseUrl = "http://localhost:" + randomPort + "/api/user/" +
// testUser.getId();
//
// User responseUser = this.restTemplate.getForObject(baseUrl, User.class);
// //ResponseEntity<User> responseEntity =
// this.restTemplate.getForEntity(baseUrl + testUser.getId(), User.class);
//
...
// User testUser = new User(5L,"password", "testFirstName",
// "testLastName","testEmail@gmail.com");
// testUser.setApproved(false);
//
// final String baseUrl = "http://localhost:" + randomPort + "/api/approveUser/"
// + testUser.getId();
//
...
// User testUser = new User(6L,"password", "testFirstName",
// "testLastName","testEmail@gmail.com");
// testUser.setApproved(true);
//
// final String baseUrl = "http://localhost:" + randomPort + "/api/rejectUser/"
// + testUser.getId();
//
// User responseUser = this.restTemplate.getForObject(baseUrl, User.class);
//
...
// User testUser = new User(7L,"password", "testFirstName",
// "testLastName","testEmail@gmail.com");
// userService.createUser(testUser);
//
// final String baseUrl = "http://localhost:" + randomPort + "/api/delete/" +
// testUser.getId();
//
// try{
