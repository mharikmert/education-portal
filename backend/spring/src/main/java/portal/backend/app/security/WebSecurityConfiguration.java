package portal.backend.app.security;
...
public class WebSecurityConfiguration {
    ...
    @Value("${post.allowed.paths}")
    private String[] postAllowedPaths;
    @Value("${get.allowed.paths}")
    private String[] getAllowedPaths;
    @Value("${admin.allowed.paths}")
    private String[] adminAllowedPaths;
    @Value("${authorized.and.admin.allowed.paths}")
    private String[] authorizedAndAdminAllowedPaths;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(authorizedAndAdminAllowedPaths)
                .access("hasRole('ROLE_ADMIN') or hasRole('ROLE_AUTHORIZED')")
